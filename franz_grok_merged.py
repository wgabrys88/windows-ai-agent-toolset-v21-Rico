...
HUD_BG_COLORS: list[int] = [
    0x00C8FFFF,  # light yellow-ish
    0x00FFFFC8,  # light cyan-ish
    0x00E6E6E6,  # light gray
    0x00C8E6FF,  # light orange-ish
]
...
SYSTEM_PROMPT = (
    ...
    "Always return exactly one tool call. Every tool call must include 'report' that fully rewrites the entire log in the fixed template and appends one CHRONICLE line describing the action.\n"
    "If stagnating or precision is needed, call ipse_tune and adjust sampling; still rewrite the log in report."
)

DEFAULT_STORY = (
    f"FRANZ NARRATIVE IDENTITY LOG\n"
    f"{HUD_SEPARATOR}\n\n"
